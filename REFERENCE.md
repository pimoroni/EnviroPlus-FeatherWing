...
#### bme280-simple
[bme280-simple.py](examples/bme280-simple.py)
...
#### gas-sensor
[gas-sensor.py](examples/gas-sensor.py)
...
#### particulate-sensor
[particulate-sensor.py](examples/particulate-sensor.py)
...
#### proximity-and-light
[proximity-and-light.py](examples/proximity-and-light.py)
...
#### plotter-particulate
[plotter-particulate.py](examples/plotter-particulate.py)
...
#### plotters-combined
[plotters-combined.py](examples/plotters-combined.py)
...
#### test-all
[test-all.py](examples/test-all.py)
